...
<!--start of header-->
		...
		<div class="collapse navbar-collapse"
					...
					<li><a href="aboutus">About Us</a><div></div></li>
					<li><a href="safterlogininformation">User Profile</a><div></div></li>
						</ul>
					</div>
		  </div>
		</nav>
            ...
            <ul class="list-group userInfo-service" id="userinfoNav">
                <a class="header">User Profile</a>
                  ...
                  <input type="hidden" id="tabContentId" value="baseInfo">
                	<a class="list-group-item active" id="navBaseInfo" href="safterlogininformation">Settings</a>
                	<a class="list-group-item active" id="navBaseInfo" href="safterloginproject">All Courses</a>
                	<a href='<s:url action="safterloginproject">
    		</s:url>'></a>
                	
                <a class="list-group-item" id="publishTheProject" href="appliedproject">My Courses</a>
                
                <a class="list-group-item" id="publishTheProject" href="appliedproject">
                    tot credit: <s:property value="totalcredit"/></a>    
                <a class="list-group-item" id="publishTheProject" href="appliedproject">
                    GPA: <s:property value="gpa"/></a> 
            </ul>
  		  </div>
		...
		<s:iterator id="u" value="pp">
			<div class="col-md-12 phone">
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>Course ID:</label>
		           <s:property value="#u.id"/>
		         </div>
		        
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>Course name:</label>
		           <s:property value="#u.name"/>
		         </div>
		         
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>Course Info:</label>
		           <s:property value="#u.info"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>semester:</label>
		           <s:property value="#u.semester"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>time:</label>
		           <s:property value="#u.time"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>credit:</label>
		           <s:property value="#u.credit"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>score:</label>
