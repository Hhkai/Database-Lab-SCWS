		     ...
		     <form id="userInfoForm" class="form-horizontal" action="javascript:doSave()" role="form" method="post">
		       ...
		       <fieldset>
				...
				<div class="col-md-12 phone">
		         ...
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>年龄:</label>
		         ...
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>联系方式:</label>
		         ...
		         <div class="col-md-12 col-md-offset-1">
		           ...
		           <s:property value="user.language"/>
		         </div>
