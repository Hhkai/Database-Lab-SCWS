...
<body>
	...
	<form action="giveascore" method="get" class="form-horizontal"
		role="form">
		<!-- <form class="form-horizontal" id="publishRequestFormStep2" role="form" method="post"> -->
		<fieldset>
			<h1 class="text-center wbm-tell-name">give score</h1>
			
			<div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>项目内容:</label>
		           <s:property value="g_stuid"/>
		    </div>
		    <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>项目内容:</label>
		           <s:property value="g_sname"/>
		    </div>
		    <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>项目内容:</label>
		           <s:property value="g_courseid"/>
		    </div>
		    <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>项目内容:</label>
		           <s:property value="g_cname"/>
		    </div>

			<div class="form-group form-group-a col-md-12">
				<label for="projectName"><i class="form-required">*</i>new score</label><br>
				<div class="col-md-12">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="newscore" placeholder="a new score" required>
				</div>
			</div>
			

			<div class="col-xs-6 col-md-6">
				<center><button type="submit" class="btn btn-lg btn-primary pull-right">submit</button></center>
			</div>
		</fieldset>
	</form>
	</div>
