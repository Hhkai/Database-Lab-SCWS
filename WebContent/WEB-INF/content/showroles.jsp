...
<!--start of header-->
		...
		<div class="collapse navbar-collapse"
					...
					<li><a href="safterlogininformation">个人中心</a><div></div></li>
						</ul>
					</div>
		  </div>
		</nav>
...
<a class="list-group-item" id="navOptions" href="scheckcontract">我的合同</a>
			...
			<div class="col-md-12 phone">
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>职位名称:</label>
		           <s:property value="#q.rname"/>
		         </div>
		        
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>所属项目:</label>
		           <s:property value="#q.pname"/>
		         </div>
		         
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>需要的技术:</label>
		           <s:property value="#q.language"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>要求的教育背景:</label>
		           <s:property value="#q.education"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>所在地:</label>
		           <s:property value="#q.city"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>需要人数:</label>
		           <s:property value="#q.number"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>剩余数量:</label>
		           <s:property value="#q.numberleft"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
