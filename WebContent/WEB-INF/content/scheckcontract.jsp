...
<s:iterator id="u" value="cc">
		       ...
		       <!--    <div class="col-md-1 col-md-offset-1">
		        ...
		        <p>甲方：<s:property value="#u.cname"/><p>
<p>乙方：<s:property value="#u.sname"/></p> 　　
<p>双方经反复协商一致，就下列事宜达成协议： </p>　　
<p>一、甲乙双方自愿签订本协议书，甲乙双方达成如下协议。 　　</p>
<p>二、双方协商确定，乙方将于<s:property value="#u.date"/>至<s:property value="#u.dend"/>在甲方公司工作 </p>　　
<p>三、双方协商确定，乙方在合同期间应完成<s:property value="u.content"/>。 　　 </p>　　　
<p>四、以上事实清楚，甲乙双方无异议。 　</p>　　　　
<p>五、合同争议的解决方式：本合同在履行过程中发生的争议，由双方当事人协商解决;也可由当地工商行政管理部门进行调解;协商或调解不成的，按下列方式解决： </p>　　
    <p>(一)提交仲裁委员会仲裁。　　</p>
    <p>(二)依法向人民法院起诉。</p>
 　　　
<p>甲方：     (签章)  
