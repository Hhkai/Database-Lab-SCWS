  	...
  	<div class="container">
	      <div class="col-lg-2 col-md-2 userInfo-left-nav">
            <ul class="list-group userInfo-service" id="userinfoNav">
                ...
                <a class="list-group-item" id="publishTheProject" href="cpublished">Check Courses</a>
<a class="list-group-item" id="publishTheProject" href="cpublish">Open Course</a>
                <a class="list-group-item" id="publishTheProject" href="ccheckcontract">Score</a>
                       </ul>
  		  </div>
		     ...
		     <form id="userInfoForm" class="form-horizontal" action="javascript:doSave()" role="form" method="post">
		       ...
		       <div class="col-md-12 phone">
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>Student ID:</label>
		           <s:property value="#u.stuid"/>
		         </div>
		        
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>Student name:</label>
		           <s:property value="#u.sname"/>
		         </div>
		         
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>Course ID:</label>
		           <s:property value="#u.courseid"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>Course Name:</label>
		           <s:property value="#u.cname"/>
		         </div>
				...
				<div class="form-group form-group-a col-md-12">
						<label for="projectName"><i class="form-required"></i></label>
						<a href="<s:url action="giveonepersonscore">
		           		<s:param name="g_courseid" value='#u.courseid' />
		           		<s:param name="g_cname" value='#u.cname' />
		           		<s:param name="g_sname" value='#u.sname' />
		           		<s:param name="g_stuid" value='#u.stuid' /></s:url>">
		           <input type="button" value="change score"/></a>
				</div>
