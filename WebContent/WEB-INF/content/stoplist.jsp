...
<body>
	...
	<fieldset>
			<h1 class="text-center wbm-tell-name">本平台优秀程序员光荣榜</h1>
			
			<s:iterator id="u" value="s">
			
			<div class="col-md-12 phone">
		         <div class="col-md-12 col-md-offset-3">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>技术大牛的姓名:</label>
		           <s:property value="#u.name"/>
		         </div>
		         <div class="col-md-12 col-md-offset-3">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>技术大牛所在地:</label>
		           <s:property value="#u.city"/>
		         </div>
		         <div class="col-md-12 col-md-offset-3">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>技术大牛的Email:</label>
		           <s:property value="#u.email"/>
		         </div>
		         
		       </div>
		       <li class="col-md-12 col-md-offset-3">
						<input id="login" class="btn login" type="button" onclick="javascript:location.href='login'" value="邀请需登录">
						</li>
		       <div><br><br><br></div>
		       </s:iterator>
