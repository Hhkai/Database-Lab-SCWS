	      ...
	      <div class="col-lg-2 col-md-2 userInfo-left-nav">
            <ul class="list-group userInfo-service" id="userinfoNav">
                ...
                <a class="list-group-item active" id="navBaseInfo" href="safterlogininformation">Settings</a>
                	<a class="list-group-item active" id="navBaseInfo" href="safterloginproject">Check Course</a>
                	<a href='<s:url action="safterloginproject">
    		</s:url>'></a>
                	
                <a class="list-group-item" id="publishTheProject" href="appliedproject">Open Course</a>
                <a class="list-group-item" id="publishTheProject" href="safterlogininvite">Score</a>              
</ul>
  		  </div>
