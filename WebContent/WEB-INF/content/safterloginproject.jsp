...
<!--start of header-->
		...
		<div class="collapse navbar-collapse"
					...
					<li><a href="safterlogininformation">Sign out</a><div></div></li>
						</ul>
					</div>
		  </div>
		</nav>
  	...
  	<div class="container">
	      <div class="col-lg-2 col-md-2 userInfo-left-nav">
            <ul class="list-group userInfo-service" id="userinfoNav">
                ...
                <a class="list-group-item" id="publishTheProject" href="safterlogininvite">Settings</a>              
</ul>
  		  </div>
			...
			<div class="col-md-12 phone">
		         ...
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>Info:</label>
		         ...
		         <div class="col-md-12 col-md-offset-1">
		           ...
		           <a href="<s:url action="showroles"><s:param name="courseid" value='#u.id' /></s:url>"><input type="button" value="select it"/></a>
		         </div>
		       </div>
		       </s:iterator>
