		     ...
		     <form id="userInfoForm" class="form-horizontal" action="javascript:doSave()" role="form" method="post">
		       ...
		       <div class="col-md-12 phone">
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>id: </label>
		           <s:property value="#u.id"/>
		         </div>
		        
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>name: </label>
