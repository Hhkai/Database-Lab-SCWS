		     ...
		     <form id="userInfoForm" class="form-horizontal" action="javascript:doSave()" role="form" method="post">
		       ...
		       <div class="col-md-12 phone">
		         ...
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>手机号:</label>
		           <s:property value="company.account"/>
		         </div>
		         
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>公司名称:</label>
		           <s:property value="company.cname"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>城市:</label>
		           <s:property value="company.city"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>联系人:</label>
		           <s:property value="company.linkman"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>联系人电话:</label>
		           <s:property value="company.phone"/>
		         </div>
		         <div class="col-md-12 col-md-offset-1">
		           <label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>Email:</label>
